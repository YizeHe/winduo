...
class SimpleGUIInterpreter:
    ...
    def parse_script(self, script_path):
        ...
        try:
            ...
            # 将解释器实例、tkinter 和 usf 注入到脚本的全局变量中
            ...
            self.script_globals["usf"] = __import__("usf")  # 自动导入 usf 库
                ...
                try:
                    if command == "script":
                        if len(tokens) < 3 or tokens[1] != "=":
                            print(f"警告: 'script' 命令格式无效 - 行='{line}'")
                            continue
                        ...
                        print(f"警告: 未知命令 '{command}' - 行='{line}'")
